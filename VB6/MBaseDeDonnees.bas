...
Public Function ChargeCuves() As String
    ...
    ' DEC
    CORRESPONDANCES_IDX_AUTOMATE(3) = 3
    ' SAT
    CORRESPONDANCES_IDX_AUTOMATE(4) = 4
    ' C05
    CORRESPONDANCES_IDX_AUTOMATE(5) = 7
    ' C10
    CORRESPONDANCES_IDX_AUTOMATE(6) = 10
    ' C13
    CORRESPONDANCES_IDX_AUTOMATE(7) = 15
    ' C14
    CORRESPONDANCES_IDX_AUTOMATE(8) = 16
    ' C15
    CORRESPONDANCES_IDX_AUTOMATE(9) = 17
    ' C17
    CORRESPONDANCES_IDX_AUTOMATE(10) = 19
    ' C22
    CORRESPONDANCES_IDX_AUTOMATE(11) = 24
    ' C23
    CORRESPONDANCES_IDX_AUTOMATE(12) = 25
    ' C25
    CORRESPONDANCES_IDX_AUTOMATE(13) = 27
    ' C27
    CORRESPONDANCES_IDX_AUTOMATE(14) = 29
    ' C28
    CORRESPONDANCES_IDX_AUTOMATE(15) = 30
    ' C31
    CORRESPONDANCES_IDX_AUTOMATE(16) = 33
    ' C32
    CORRESPONDANCES_IDX_AUTOMATE(17) = 34
    ' C33
    CORRESPONDANCES_IDX_AUTOMATE(18) = 35
    ' C34
    CORRESPONDANCES_IDX_AUTOMATE(19) = 36
    ' C35
    CORRESPONDANCES_IDX_AUTOMATE(20) = 37
    
    
    CORRESPONDANCES_IDX_CUVES_API(1) = -1
    CORRESPONDANCES_IDX_CUVES_API(2) = -1
    CORRESPONDANCES_IDX_CUVES_API(3) = 1
    CORRESPONDANCES_IDX_CUVES_API(4) = 2
    CORRESPONDANCES_IDX_CUVES_API(5) = 3
    CORRESPONDANCES_IDX_CUVES_API(6) = 4
    CORRESPONDANCES_IDX_CUVES_API(7) = -1
    CORRESPONDANCES_IDX_CUVES_API(8) = -1
    CORRESPONDANCES_IDX_CUVES_API(9) = 5
    CORRESPONDANCES_IDX_CUVES_API(10) = -1
    CORRESPONDANCES_IDX_CUVES_API(11) = -1
    CORRESPONDANCES_IDX_CUVES_API(12) = -1
    CORRESPONDANCES_IDX_CUVES_API(13) = -1
    CORRESPONDANCES_IDX_CUVES_API(14) = 6
    CORRESPONDANCES_IDX_CUVES_API(15) = -1
    CORRESPONDANCES_IDX_CUVES_API(16) = -1
    CORRESPONDANCES_IDX_CUVES_API(17) = 7
    CORRESPONDANCES_IDX_CUVES_API(18) = 8
    CORRESPONDANCES_IDX_CUVES_API(19) = 9
    CORRESPONDANCES_IDX_CUVES_API(20) = -1
    CORRESPONDANCES_IDX_CUVES_API(21) = 10
    CORRESPONDANCES_IDX_CUVES_API(22) = -1
    CORRESPONDANCES_IDX_CUVES_API(23) = -1
    CORRESPONDANCES_IDX_CUVES_API(24) = -1
    CORRESPONDANCES_IDX_CUVES_API(25) = -1
    CORRESPONDANCES_IDX_CUVES_API(26) = 11
    CORRESPONDANCES_IDX_CUVES_API(27) = 12
    CORRESPONDANCES_IDX_CUVES_API(28) = -1
    CORRESPONDANCES_IDX_CUVES_API(29) = 13
    CORRESPONDANCES_IDX_CUVES_API(30) = -1
    CORRESPONDANCES_IDX_CUVES_API(31) = 14
    CORRESPONDANCES_IDX_CUVES_API(32) = 15
    CORRESPONDANCES_IDX_CUVES_API(33) = -1
    CORRESPONDANCES_IDX_CUVES_API(34) = -1
    CORRESPONDANCES_IDX_CUVES_API(35) = 16
    CORRESPONDANCES_IDX_CUVES_API(36) = 17
    CORRESPONDANCES_IDX_CUVES_API(37) = 18
    CORRESPONDANCES_IDX_CUVES_API(38) = 19
    CORRESPONDANCES_IDX_CUVES_API(39) = 20
    CORRESPONDANCES_IDX_CUVES_API(40) = -1
    CORRESPONDANCES_IDX_CUVES_API(41) = -1
    CORRESPONDANCES_IDX_CUVES_API(42) = -1
    CORRESPONDANCES_IDX_CUVES_API(43) = -1
    CORRESPONDANCES_IDX_CUVES_API(44) = -1
    CORRESPONDANCES_IDX_CUVES_API(45) = -1
    ...
    With Enregistrement
        ...
        Do While Not .EOF
            ...
            If TCaracteristiquesCuves(NumCuve).DefinitionCuve.GestionAPI = True Then
                TEtatsCuvesAPI(CptCuvesAPI).DefinitionCuve = TCaracteristiquesCuves(NumCuve).DefinitionCuve
                TEtatsCuvesAPI(CptCuvesAPI).IndexAutomate = CORRESPONDANCES_IDX_AUTOMATE(CptCuvesAPI)
                Inc CptCuvesAPI
            End If
