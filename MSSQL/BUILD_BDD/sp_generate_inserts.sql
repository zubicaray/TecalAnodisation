USE [ANODISATION]
GO
/****** Object:  StoredProcedure [dbo].[sp_generate_inserts]    Script Date: 24/10/2024 11:19:01 ******/
SET ANSI_NULLS ON
GO
	...
	BEGIN
		...
		CASE
			...
			WHEN @Data_Type IN ('date','datetime','smalldatetime')
				THEN
					'COALESCE('''''''' + RTRIM(replace(CONVERT(char,' + @Column_Name + ',120),''-'','''') COLLATE DATABASE_DEFAULT)+'''''''',''NULL'')'
