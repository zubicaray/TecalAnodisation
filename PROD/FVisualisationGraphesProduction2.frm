...
Begin VB.Form FVisualisationGraphesProduction 
   ...
   ClientTop       =   2460
   ClientWidth     =   17055
   Icon            =   "FVisualisationGraphesProduction2.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame FChoixMesures 
      ...
      Begin VB.Image IPhasesAnodisation 
         Height          =   2010
         Left            =   705
         Picture         =   "FVisualisationGraphesProduction2.frx":0442
         Top             =   3195
         Width           =   2925
      End
   ...
   Begin VB.PictureBox PBRenseignementsFenetre 
      ...
      Height          =   375
      Left            =   0
      Picture         =   "FVisualisationGraphesProduction2.frx":1384C
      ScaleHeight     =   315
      ScaleWidth      =   16995
      TabIndex        =   4
      Top             =   0
   ...
   Begin VB.PictureBox PBBoutons 
      ...
      Begin VB.CommandButton CBImprimerGraphe 
         ...
         DownPicture     =   "FVisualisationGraphesProduction2.frx":3818E
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
         ...
         Left            =   10800
         MaskColor       =   &H00FF00FF&
         Picture         =   "FVisualisationGraphesProduction2.frx":38890
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   120
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton CBQuitter 
         ...
         Cancel          =   -1  'True
         Caption         =   "&Quitter"
         DownPicture     =   "FVisualisationGraphesProduction2.frx":38F92
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
         ...
         Left            =   13260
         MaskColor       =   &H00FF00FF&
         Picture         =   "FVisualisationGraphesProduction2.frx":39694
         Style           =   1  'Graphical
         TabIndex        =   2
